          ...
          {activeTab === value && (
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="absolute w-full h-full left-0 top-0 dark:bg-base-dark bg-white dark:bg-gray-700 rounded-md  z-[1]"
              />
            </AnimatePresence>
          )}
              ...
              {activeTab === value && (
                <AnimatePresence mode="wait">
                  <motion.div
                    ...
                    layoutId={defaultValue}
                    className="absolute w-full h-full left-0 top-0 dark:bg-base-dark bg-white dark:bg-gray-700 rounded-md  z-[1] tab-shadow"
                  />
                </AnimatePresence>
              )}
              {activeTab === value && (
